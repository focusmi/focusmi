...
class LayOut {
  ...
  Widget mainLayoutWithDrawerFloatingBtn(
      context, Widget widget, appbarname, Task task) {
    var user = Provider.of<UserProvider>(context, listen: false).user;
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
        ...
        floatingActionButton: SizedBox(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () => Navigator.pushNamed(
                  context, PomodoroTimerScreen.routeName,
                  arguments: task),
            )));
  }
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  // _onItemTapped(2);
                  Navigator.pushNamed(
                      context, CounselorsListWidgetWidget.routeName);
                  // Then close the drawer
                },
              ),
              ListTile(
                ...
                onTap: () {
                  ...
                  // _onItemTapped(2);
                  Navigator.pushNamed(
                      context, ViewAppointmentsWidget.routeName);
                  // Then close the drawer
                },
              ),
              ListTile(
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        const ViewAppointmentsWidget(), // Replace YourNewScreen with the name of your new screen widget
                  ),
                );
                // Then close the drawer
              },
