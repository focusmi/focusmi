...
class SetTimeScheduleService {
  static Future<List<Schedule>> fetchSchedules(BuildContext context) async {
    ...
    final response = await http.get(
      Uri.parse('$uri/apis/schedule/time/${user.}'),
  ...
  static Future<void> createSchedule(
    ...
    try {
      existingSchedules =
          (await AppointmentService.getPreviousAppointments(user.user_id)).cast<Schedule>();
      ;
    } catch (e) {
    ...
    final existingSchedulesOnSelectedDate = existingSchedules.where(
        (existingSchedule) =>
