...
class _AuthScreenState extends State<AuthScreen> {
 ...
 @override
  ...
  void signUpUser(){
    authService.createUser(email: _email.text,password: _password.text,username: _username.text,context: context );
  }
  @override
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                textField.createFormField(_username, "Enter Your Username", false, 'Username', r'^[A-Za-z][A-Za-z0-9_]{4,29}$','Please enter a correct username'),
